...
import type { ConsultationPillar } from '../../data/consultationPillars';
import { Button } from '../ui/Button';

interface ConsultationPillarModalProps {
  pillar: ConsultationPillar | null;
  onClose: () => void;
  onNavigateCertidao?: () => void;
}

export const ConsultationPillarModal: React.FC<ConsultationPillarModalProps> = ({
  pillar,
  onClose,
  onNavigateCertidao,
}) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="consultation-pillar-title"
      onClick={onClose}
    >
      <div
        ...
        <div className="flex items-start justify-between gap-3 border-b border-vebook-mustard/35 bg-vebook-navy px-5 py-4 text-vebook-white">
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <h2 id="consultation-pillar-title" className="text-lg font-bold tracking-tight">
                {pillar.title}
              </h2>
